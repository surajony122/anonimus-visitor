...
import { useActionData, useLoaderData, useNavigate, useSubmit, useNavigation, useRouteError } from "@remix-run/react";
  ...
  try {
    ...
    if (shop) {
      ...
      visitors = await prisma.visitor.findMany({
        where: { OR: [{ shopId: shop.id }, { shopId: null }] },
        include: {
          sessions: true,
          events: true,
          identities: true,
...
export function ErrorBoundary() {
  ...
  console.error("Intent Intelligence Route Error:", error);
      ...
      <div style={{ padding: "30px", maxWidth: "800px", margin: "0 auto" }}>
        <div style={{ background: "#fff4f4", border: "1px solid #fecaca", borderRadius: "10px", padding: "24px" }}>
          <h2 style={{ color: "#b91c1c", margin: "0 0 10px 0", fontSize: "18px", fontWeight: 700 }}>
            ⚠️ Intent Intelligence Loading Notice
          </h2>
