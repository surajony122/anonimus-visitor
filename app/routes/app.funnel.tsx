...
export default function FunnelAnalyticsRoute() {
  ...
  const offerAnalytics = useMemo(() => {
    const offers = [
      { code: "JOY15", label: "Flat 15% Off Exclusive", appliedCount: 48, orders: 36, discountGiven: "₹18,400", netRevenue: "₹1,04,200", revenue: "₹1,04,200", conversionRate: "75%" },
      { code: "FLAT10", label: "Welcome 10% Off", appliedCount: 82, orders: 49, discountGiven: "₹14,200", netRevenue: "₹1,28,000", revenue: "₹1,28,000", conversionRate: "60%" },
      { code: "FESTIVE20", label: "Festive Season 20%", appliedCount: 29, orders: 21, discountGiven: "₹12,800", netRevenue: "₹51,200", revenue: "₹51,200", conversionRate: "72%" },
      { code: "FREESHIP", label: "Free Express Shipping", appliedCount: 110, orders: 84, discountGiven: "₹8,400", netRevenue: "₹2,10,000", revenue: "₹2,10,000", conversionRate: "76%" },
    ];
